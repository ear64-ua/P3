...
public class TestExamen {
	...
	@Test
	public void testCrossN() throws InvalidSizeException, FighterAlreadyInBoardException, OutOfBoundsException {
		 Board b = new Board(10);
		
		assertEquals("[[3,2], [3,1], [3,0]]",b.getDirection("N", new Coordinate(3,3)).toString());
	}
	
	@Test
	public void testCrossS() throws InvalidSizeException, FighterAlreadyInBoardException, OutOfBoundsException {
		 Board b = new Board(10);
		
		 assertEquals("[[3,4], [3,5], [3,6], [3,7], [3,8], [3,9]]",b.getDirection("S", new Coordinate(3,3)).toString());
	}
	
	@Test
	public void testCrossE() throws InvalidSizeException, FighterAlreadyInBoardException, OutOfBoundsException {
		 Board b = new Board(10);
		
		 assertEquals("[[4,3], [5,3], [6,3], [7,3], [8,3], [9,3]]",b.getDirection("E", new Coordinate(3,3)).toString());
	}
	
	@Test
	public void testCrossW() throws InvalidSizeException, FighterAlreadyInBoardException, OutOfBoundsException {
		 Board b = new Board(10);
		
		 assertEquals("[[2,3], [1,3], [0,3]]",b.getDirection("W", new Coordinate(3,3)).toString());
	}
	...
	public void testExamen() {
		...
		pfImperial.nextPlay(); // launch 7 5  (id=2)
		...
		pfRebel.nextPlay(); // launch 5 0  (id=3)
		pfRebel.nextPlay(); // launch 2 5  (id=4)
		pfRebel.nextPlay(); // launch 9 5  (id=5)
		pfRebel.nextPlay(); // launch 5 6  (id=6)
...
//      gs = pfImperial.getGameShip();
	...
	@Test
	public void testNextPlayWithErrorsInCross() {
